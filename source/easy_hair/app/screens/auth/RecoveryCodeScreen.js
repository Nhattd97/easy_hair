...
class RecoveryCodeScreen extends Component {
      ...
      <View style={styles.header}>
        <View>
          <TouchableOpacity style={styles.headerLeftBtn} onPress={() => {
            ...
            <Image style={{width: 30, height: 30}} source={require('../../assets/images/Back_WHITE.png')}
                   resizeMethod='resize'/>
          </TouchableOpacity>
        ...
        <View style={styles.footer}>
          ...
          <View style={styles.proceedBtnWrap}>
            ...
            <TouchableOpacity style={[styles.proceedBtn, this.state.active == true && styles.proceedBtnOn]}
              ...
              <Text
                style={[styles.proceedBtnTitle, this.state.active == true && styles.proceedBtnTitleOn]}>{'Tiếp theo'}</Text>
